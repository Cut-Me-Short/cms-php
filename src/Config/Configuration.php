...
namespace CutMeShort\SDK\Config;

/**
 * Configuration class for CutMeShort SDK
 *
 * @package CutMeShort\SDK\Config
 */
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://www.app.cutmeshort.com';
     ...
     * @var string
     */
    protected $userAgent = 'CutMeShort-SDK/1.0.0/PHP';
     ...
     *
     * @param string $keyFile Certificate key path
     * @return $this
     */
    ...
    {
        $report  = 'CutMeShort SDK Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    SDK Version: 1.0.0' . PHP_EOL;
     ...
     *
     * @param string $apiKeyIdentifier API key identifier
     *
     * @return string API key with prefix if set
     */
